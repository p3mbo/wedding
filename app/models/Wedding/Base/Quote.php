...
abstract class Quote implements ActiveRecordInterface 
{
     ...
     * @return ObjectCollection|ChildQuoteItem[] List of ChildQuoteItem objects
     */
    public function getQuoteItemsJoinQuoteItemGroupItem(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildQuoteItemQuery::create(null, $criteria);
        $query->joinWith('QuoteItemGroupItem', $joinBehavior);
